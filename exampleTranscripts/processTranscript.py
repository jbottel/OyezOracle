...
def get_plot_number_of_words_per_speaker(num_words, ignore_petitioner=False, petitioner=None):
    ...
    # A list comprehension where we compile the list of tuples into two lists (converting the HumanName into a last name string)
...
def get_plot_number_of_statements_per_speaker(grouping_of_statements, ignore_petitioner=False, petitioner=None):
    ...
    plot = get_plot_names_and_numbers(names, numbers, "Number of Interruptions","Number of Individual Interruptions in Argument")
